...
namespace Envoice.Conditions
{
    ...
    internal static class SR
    {
        ...
        private static readonly ResourceManager resource = new ResourceManager(typeof (ExceptionMessages));
        // new ResourceManager(typeof (SR).Namespace + ".ExceptionMessages", Assembly.Load(""));
        ...
        private static string GetStringInternal(string name, params object[] args)
        {
            ...
            var format = resource.GetString(name, CultureInfo.CurrentUICulture);
