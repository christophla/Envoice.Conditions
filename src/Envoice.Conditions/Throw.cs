...
namespace Envoice.Conditions
{
    ...
    internal static class Throw
    {
        ...
        {
            var condition = GetFormattedConditionMessage(validator, SR.CollectionShouldBeEmpty,
        ...
        {
            var condition = GetFormattedConditionMessage(validator, SR.CollectionShouldContainX,
        ...
        internal static void CollectionShouldContainAllOf<T>(ConditionValidator<T> validator, IEnumerable values,
            string conditionDescription) where T : IEnumerable
        {
            var condition = GetFormattedConditionMessage(validator, SR.CollectionShouldContainAllOfX,
        ...
        {
            var condition = GetFormattedConditionMessage(validator, SR.CollectionShouldContainAtLeastOneOfX,
                conditionDescription, validator.ArgumentName, values.Stringify());
        ...
        internal static void CollectionShouldNotBeEmpty<T>(ConditionValidator<T> validator,
            string conditionDescription) where T : IEnumerable
        {
            var condition = GetFormattedConditionMessage(validator, SR.CollectionShouldNotBeEmpty,
                conditionDescription, validator.ArgumentName);
        ...
        {
            var condition = GetFormattedConditionMessage(validator, SR.CollectionShouldNotContainX,
                conditionDescription, validator.ArgumentName, value.Stringify());
        ...
        internal static void CollectionShouldNotContainAllOf<T>(ConditionValidator<T> validator, IEnumerable values,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.CollectionShouldNotContainAllOfX,
                conditionDescription, validator.ArgumentName, values.Stringify());
        ...
        internal static void CollectionShouldNotContainAnyOf<T>(ConditionValidator<T> validator, IEnumerable values,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.CollectionShouldNotContainAnyOfX,
                conditionDescription, validator.ArgumentName, values.Stringify());
            ...
            where T : IEnumerable
        {
            ...
            var numberOfElements = CollectionHelpers.GetLength(collection);
        ...
        internal static void LambdaXShouldHoldForValue<T>(ConditionValidator<T> validator, LambdaExpression lambda,
            string conditionDescription)
        {
            var lambdaDefinition = GetLambdaDefinition(lambda);

            var condition = GetFormattedConditionMessage(validator, SR.LambdaXShouldHoldForValue,
            ...
            string conditionDescription)
        {
            ...
            var additionalMessage = GetActualStringLengthMessage(validator);
        ...
        internal static void StringShouldBeNullOrWhiteSpace(ConditionValidator<string> validator,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.StringShouldBeNullOrWhiteSpace,
                conditionDescription, validator.ArgumentName);
        ...
        internal static void StringShouldContain(ConditionValidator<string> validator, string value,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.StringShouldContainX,
                conditionDescription, validator.ArgumentName, value.Stringify());
        ...
        internal static void StringShouldEndWith(ConditionValidator<string> validator, string value,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.StringShouldEndWithX,
                conditionDescription, validator.ArgumentName, value.Stringify());
        ...
        internal static void StringShouldNotBeNullOrWhiteSpace(ConditionValidator<string> validator,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.StringShouldNotBeNullOrWhiteSpace,
                conditionDescription, validator.ArgumentName);
        ...
        internal static void StringShouldNotContain(ConditionValidator<string> validator, string value,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.StringShouldNotContainX,
                conditionDescription, validator.ArgumentName, value.Stringify());
        ...
        internal static void StringShouldNotEndWith(ConditionValidator<string> validator, string value,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.StringShouldNotEndWithX,
                conditionDescription, validator.ArgumentName, value.Stringify());
        ...
        internal static void StringShouldNotStartWith(ConditionValidator<string> validator, string value,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.StringShouldNotStartWithX,
                conditionDescription, validator.ArgumentName, value.Stringify());
        ...
        internal static void StringShouldStartWith(ConditionValidator<string> validator, string value,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.StringShouldStartWithX,
                conditionDescription, validator.ArgumentName, value.Stringify());
        ...
        internal static void ValueShouldBeAnEmptyString(ConditionValidator<string> validator,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.StringShouldBeEmpty,
                conditionDescription, validator.ArgumentName);
        ...
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldBeANumber,
                conditionDescription, validator.ArgumentName);
        ...
        internal static void ValueShouldBeBetween<T>(ConditionValidator<T> validator, T minValue, T maxValue,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldBeBetweenXAndY,
        ...
        internal static void ValueShouldBeEqualTo<T>(ConditionValidator<T> validator, T value,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldBeEqualToX,
                conditionDescription, validator.ArgumentName, value.Stringify());
        ...
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldBeFalse,
                conditionDescription, validator.ArgumentName);
        ...
        internal static void ValueShouldBeGreaterThan<T>(ConditionValidator<T> validator, T minValue,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldBeGreaterThanX,
        ...
        internal static void ValueShouldBeGreaterThanOrEqualTo<T>(ConditionValidator<T> validator, T minValue,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldBeGreaterThanOrEqualToX,
                conditionDescription, validator.ArgumentName, minValue.Stringify());
        ...
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldBeInfinity,
                conditionDescription, validator.ArgumentName);
        ...
        internal static void ValueShouldBeNegativeInfinity<T>(ConditionValidator<T> validator,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldBeNegativeInfinity,
                conditionDescription, validator.ArgumentName);
        ...
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldBeNull,
                conditionDescription, validator.ArgumentName);
        ...
        internal static void ValueShouldBeNullOrAnEmptyString(ConditionValidator<string> validator,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.StringShouldBeNullOrEmpty,
                conditionDescription, validator.ArgumentName);
        ...
        internal static void ValueShouldBeOfType<T>(ConditionValidator<T> validator, Type type,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldBeOfTypeX,
        ...
        internal static void ValueShouldBePositiveInfinity<T>(ConditionValidator<T> validator,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldBePositiveInfinity,
                conditionDescription, validator.ArgumentName);
        ...
        internal static void ValueShouldBeSmallerThan<T>(ConditionValidator<T> validator, T maxValue,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldBeSmallerThanX,
        ...
        internal static void ValueShouldBeSmallerThanOrEqualTo<T>(ConditionValidator<T> validator, T maxValue,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldBeSmallerThanOrEqualToX,
                conditionDescription, validator.ArgumentName, maxValue.Stringify());
        ...
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldBeTrue,
                conditionDescription, validator.ArgumentName);
        ...
        internal static void ValueShouldNotBeAnEmptyString(ConditionValidator<string> validator,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.StringShouldNotBeEmpty,
                conditionDescription, validator.ArgumentName);
        ...
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldNotBeANumber,
                conditionDescription, validator.ArgumentName);
        ...
        internal static void ValueShouldNotBeGreaterThan<T>(ConditionValidator<T> validator, T minValue,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldNotBeGreaterThanX,
                conditionDescription, validator.ArgumentName, minValue.Stringify());
        ...
        internal static void ValueShouldNotBeGreaterThanOrEqualTo<T>(ConditionValidator<T> validator, T maxValue,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldNotBeGreaterThanOrEqualToX,
                conditionDescription, validator.ArgumentName, maxValue.Stringify());
        ...
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldNotBeInfinity,
                conditionDescription, validator.ArgumentName);
        ...
        internal static void ValueShouldNotBeNegativeInfinity<T>(ConditionValidator<T> validator,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldNotBeNegativeInfinity,
                conditionDescription, validator.ArgumentName);
        ...
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldNotBeNull,
                conditionDescription, validator.ArgumentName);
        ...
        internal static void ValueShouldNotBeNullOrAnEmptyString(ConditionValidator<string> validator,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.StringShouldNotBeNullOrEmpty,
                conditionDescription, validator.ArgumentName);
        ...
        internal static void ValueShouldNotBeOfType<T>(ConditionValidator<T> validator, Type type,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldNotBeOfTypeX,
                conditionDescription, validator.ArgumentName, type.Name);
        ...
        internal static void ValueShouldNotBePositiveInfinity<T>(ConditionValidator<T> validator,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldNotBePositiveInfinity,
                conditionDescription, validator.ArgumentName);
        ...
        internal static void ValueShouldNotBeSmallerThan<T>(ConditionValidator<T> validator, T minValue,
            string conditionDescription)
        {
            var condition = GetFormattedConditionMessage(validator, SR.ValueShouldNotBeSmallerThanX,
                conditionDescription, validator.ArgumentName, minValue.Stringify());
