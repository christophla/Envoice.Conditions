...
namespace Envoice.Conditions
{
    ...
    public static partial class ValidatorExtensions
    {
        ...
        ///     specified <paramref name="validator" /> is <b>true</b>, while the specified <paramref name="validator" /> is
        ...
        /// <exception cref="ArgumentException">
        ///     Thrown when the <see cref="ConditionValidator{T}.Value">Value</see> of the
        ///     specified <paramref name="validator" /> is <b>true</b> or null, while the specified <paramref name="validator" />
        ...
        /// <exception cref="ArgumentException">
        ///     Thrown when the <see cref="ConditionValidator{T}.Value">Value</see> of the
        ///     specified <paramref name="validator" /> is <b>false</b>, while the specified <paramref name="validator" /> is
        ///     created using the <see cref="Condition.Requires{T}(T,string)">Requires</see> extension method.
        /// </exception>
        /// <exception cref="PostconditionException">
        ///     Thrown when the <see cref="ConditionValidator{T}.Value">Value</see> of the
        ...
        /// <exception cref="ArgumentException">
        ///     Thrown when the <see cref="ConditionValidator{T}.Value">Value</see> of the
        ///     specified <paramref name="validator" /> is <b>false</b> or null, while the specified <paramref name="validator" />
        ///     is created using the <see cref="Condition.Requires{T}(T,string)">Requires</see> extension method.
        /// </exception>
        /// <exception cref="PostconditionException">
        ///     Thrown when the <see cref="ConditionValidator{T}.Value">Value</see> of the
