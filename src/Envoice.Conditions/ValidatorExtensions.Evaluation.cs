...
namespace Envoice.Conditions
{
    ...
    public static partial class ValidatorExtensions
    {
        ...
        ///     <paramref name="expression" /> has to be <see cref="Expression{T}.Compile(Boolean)">compiled</see> on each
        ...
        ///     Thrown when the <paramref name="expression" /> evaluated false or is a null
        ...
        ///     Thrown when the <paramref name="expression" /> evaluated false or is a null
        ///     reference and the <see cref="ConditionValidator{T}.Value">Value</see> of the specified
        ///     <paramref name="validator" /> is a null reference, while the specified <paramref name="validator" /> is created
        ///     using the <see cref="Condition.Requires{T}(T,string)">Requires</see> extension method.
        /// </exception>
        /// <exception cref="InvalidEnumArgumentException">
        ///     Thrown when the <paramref name="expression" /> evaluated false or is a
        ///     null reference and the <see cref="ConditionValidator{T}.Value">Value</see> of the specified
        ///     <paramref name="validator" /> is an <see cref="System.Enum" /> type, while the specified
        ...
        {
            return Evaluate(validator, expression, null);
        }
